    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white shadow-sm h-[70px] flex items-center">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between">
          ...
          {/* Search Bar - Hidden on small screens if needed, but shown in design */}
          <div className="hidden md:flex flex-1 max-w-xl mx-8 relative">
            ...
            <input
              ...
              className="w-full h-10 pl-12 pr-4 bg-[#F5F5F5] border border-[#F5F5F5] rounded-[32px] text-sm focus:outline-none focus:border-[#1890FF] transition-colors"
            />
          </div>
          ...
          <div className="flex items-center gap-2 lg:gap-6">
            {/* Home Icon */}
            <Link to="/feed" className="relative p-2">
            ...
            <button className="relative p-2">
              ...
              <span className="absolute top-1 right-0 bg-[#1890FF] text-white text-[10px] font-bold px-1.5 py-0.5 rounded-full border-2 border-white">6</span>
            </button>
            ...
            <button className="relative p-2">
              ...
              <span className="absolute top-1 right-0 bg-[#1890FF] text-white text-[10px] font-bold px-1.5 py-0.5 rounded-full border-2 border-white">2</span>
            </button>
            ...
            <div className="relative">
              ...
              >
                ...
                <div className="hidden lg:flex items-center gap-2">
                  <span className="text-[#112032] font-medium text-sm">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <Link 
                          ...
                          className="text-sm text-[#377DFF] hover:underline"
                        >
                          View Profile
                        </Link>
                      </div>
                  ...
                  <ul className="py-2">
                    <li>
                      ...
                      >
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="6" height="10" fill="none" viewBox="0 0 6 10" className="opacity-50">
                          <path fill="#112032" d="M5 5l.354.354L5.707 5l-.353-.354L5 5zM1.354 9.354l4-4-.708-.708-4 4 .708.708zm4-4.708l-4-4-.708.708 4 4 .708-.708z"/>
                        </svg>
                      </Link>
                    </li>
                    <li>
